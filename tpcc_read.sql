-------Begin Transaction------
BEGIN;
SELECT o_id, o_entry_d, o_carrier_id FROM "order" WHERE ((o_w_id = ":-:|'o_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:") AND (o_d_id = ":-:|'o_d_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:")) AND (o_c_id = ":-:|'o_c_id','INT8','NULL','','','','','','WHERE','""order""'|:-:") ORDER BY o_id DESC LIMIT 92;
...
-------Begin Transaction------
BEGIN;
SELECT o_id, o_entry_d, o_carrier_id FROM "order" WHERE ((o_w_id = ":-:|'o_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:") AND (o_d_id = ":-:|'o_d_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:")) AND (o_c_id = ":-:|'o_c_id','INT8','NULL','','','','','','WHERE','""order""'|:-:") ORDER BY o_id DESC LIMIT 11;
