-------Begin Transaction------
BEGIN;
SELECT o_id, o_entry_d, o_carrier_id FROM "order" WHERE ((o_w_id = ":-:|'o_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:") AND (o_d_id = ":-:|'o_d_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:")) AND (o_c_id = ":-:|'o_c_id','INT8','NULL','','','','','','WHERE','""order""'|:-:") ORDER BY o_id DESC LIMIT 22;
...
-------Begin Transaction------
BEGIN;
SELECT o_id, o_entry_d, o_carrier_id FROM "order" WHERE ((o_w_id = ":-:|'o_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:") AND (o_d_id = ":-:|'o_d_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE','""order""'|:-:")) AND (o_c_id = ":-:|'o_c_id','INT8','NULL','','','','','','WHERE','""order""'|:-:") ORDER BY o_id DESC LIMIT 71;
...
SELECT count(DISTINCT s_i_id) FROM order_line JOIN stock ON (s_w_id = ":-:|'s_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE',''|:-:") AND (s_i_id = ol_i_id) WHERE (((ol_w_id = ":-:|'ol_w_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE',''|:-:") AND (ol_d_id = ":-:|'ol_d_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE',''|:-:")) AND (ol_o_id BETWEEN (":-:|'ol_o_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE',''|:-:") AND (":-:|'ol_o_id','INT8','NOT NULL','PRIMARY KEY','','','','','WHERE',''|:-:"))) AND (s_quantity < ":-:|'s_quantity','INT8','NULL','','','','','','WHERE',''|:-:");
COMMIT;
-------End Transaction-------
